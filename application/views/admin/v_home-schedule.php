<!-- Sidebar -->
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
					<h2 class="content-heading" style="padding-top: 0;">Home Schedule</h2>
							...
							<br><table class="table table-vcenter">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
											<img class="img-avatar img-avatar m-5 border-img " src="../assets/img/d1-1.png" alt="">
											<img class="img-avatar img-avatar m-5 border-img " src="../assets/img/d1-3.png" alt="">
											<img class="img-avatar img-avatar m-5 border-img " src="../assets/img/d1-5.png" alt="">
											<img class="img-avatar img-avatar m-5 border-img " src="../assets/img/d1-6.png" alt="">
										</td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-success mr-5 mb-5 no-radius2" data-toggle="tooltip" title="Edit">
													<a href="edit-home-schedule.html" class="text-white"><i class="fa fa-pencil"></i> </a>
												</button>

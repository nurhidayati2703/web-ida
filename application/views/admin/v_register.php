 <!-- Sidebar -->
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
								...
								<li class="open">
                                    <a class="nav-submenu active" data-toggle="nav-submenu" href="#"><i class="fa fa-file-text"></i><span class="sidebar-mini-hide">Form Management</span></a>
                                    <ul>
                                        <li>
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
					<h2 class="content-heading" style="padding-top: 0;">Registered</h2>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-success mr-5 mb-5 no-radius2" data-toggle="tooltip" title="Edit">
													<a href="edit-detail-schedule.html" class="text-white"><i class="fa fa-check"></i> </a>
												</button>

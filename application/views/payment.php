...
<!--HEADER END-->
    ...
    <main>
        <?php if ($this->session->flashdata('pesan_berhasil')) { ?>
                                        <div style="text-align:center; width: 300px; margin-left: 40%; margin-top: 30px;margin-bottom:-80px;"class="alert alert-success"> <?= $this->session->flashdata('pesan_berhasil')?> </div>
                                    <?php } ?>
...
$params = array('amount' => '10000.00','invoice' => "$invoice", 'currency' => '840');

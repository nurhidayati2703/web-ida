...
<head>
    ...
    <!-- SITE TITLE -->
    <title>About | Intelligent Transport System Indonesia 2019</title>
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <div class="lgx-nav-right navbar-right">
                            <div class="lgx-cart-area">
                                <a class="lgx-btn lgx-btn-red" href="<?= base_url('Buy');?>">Buy Ticket</a>
                            </div>
                        </div>
                        <ul class="nav navbar-nav lgx-nav navbar-right">
                            
                            <li><a class="lgx-scroll" href="<?= base_url();?>">Home</a></li>
                            <li><a class="lgx-scroll" href="<?= base_url('Home/about');?>">About</a></li>
							<!--<li><a class="lgx-scroll" href="#lgx-speakers">Speaker</a></li>-->
                            <li><a class="lgx-scroll" href="<?= base_url('Home/schedule');?>">Schedule</a></li>
                            <li><a class="lgx-scroll" href="<?= base_url('Home/contact');?>">Contact</a></li>
                        </ul>
                    </div><!--/.nav-collapse -->
                </nav>
            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-5">
                                    <div class="lgx-about-img">
                                        <img src="<?= base_url();?>/assets/img/about-logo.png" alt="about">
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-7">
                                    <div class="lgx-about-content-area">
                                        <div class="lgx-heading">
                                            <h2 class="heading">ITSWC 2019 POST CONFERENCE</h2>
                                            <h3 class="subheading">Why ITSWC 2019 ?</h3>
                                        </div>
                                ...
                                <div id="lgx-owltestimonial" class="lgx-owltestimonial lgx-owlnews">
                                    ...
                                    <div class="item">
                                        ...
                                        <blockquote class="lgx-testi-single">
                                            ...
                                            <div class="author">
                                                <img src="<?= base_url();?>/assets/img/ava-testimoni.jpg" alt="author">
